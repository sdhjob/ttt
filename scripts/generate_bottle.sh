...
mkdir -p ${PROJECT}/${VERSION}/opt/sou/lib/cmake
...
echo "class Ngk < Formula
   ...
   homepage \"${URL}\"
   revision 0
   url \"https://github.com/sou/sou/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/sou/sou/releases/download/v${VERSION}\"
