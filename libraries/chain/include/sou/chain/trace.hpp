...
#include <sou/chain/action_receipt.hpp>
...
FC_REFLECT( sou::chain::account_delta,
            (account)(delta) )

FC_REFLECT( sou::chain::action_trace,
...
FC_REFLECT( sou::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
