...
CHAINBASE_SET_INDEX_TYPE(sou::chain::permission_object, sou::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(sou::chain::permission_usage_object, sou::chain::permission_usage_index)

FC_REFLECT(sou::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(sou::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(sou::chain::permission_usage_object, (last_used))
