...
#include <sou/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(sou::chain::global_property_object, sou::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(sou::chain::dynamic_global_property_object,
                         sou::chain::dynamic_global_property_multi_index)

FC_REFLECT(sou::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(sou::chain::legacy::snapshot_global_property_object_v2,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(sou::chain::snapshot_global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(sou::chain::dynamic_global_property_object,
