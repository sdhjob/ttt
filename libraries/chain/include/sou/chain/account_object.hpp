...
#include <sou/chain/block_timestamp.hpp>
...
namespace sou { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      void set_abi( const sou::chain::abi_def& a ) {
         abi.resize( fc::raw::pack_size( a ) );
         fc::datastream<char*> ds( abi.data(), abi.size() );
         fc::raw::pack( ds, a );
      }

      sou::chain::abi_def get_abi()const {
         sou::chain::abi_def a;
         SOU_ASSERT( abi.size() != 0, abi_not_found_exception, "No ABI set on account ${n}", ("n",name) );
...
CHAINBASE_SET_INDEX_TYPE(sou::chain::account_object, sou::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(sou::chain::account_metadata_object, sou::chain::account_metadata_index)
CHAINBASE_SET_INDEX_TYPE(sou::chain::account_ram_correction_object, sou::chain::account_ram_correction_index)


FC_REFLECT(sou::chain::account_object, (name)(creation_date)(abi))
FC_REFLECT(sou::chain::account_metadata_object, (name)(recv_sequence)(auth_sequence)(code_sequence)(abi_sequence)
                                                  (code_hash)(last_code_update)(flags)(vm_type)(vm_version))
FC_REFLECT(sou::chain::account_ram_correction_object, (name)(ram_correction))
