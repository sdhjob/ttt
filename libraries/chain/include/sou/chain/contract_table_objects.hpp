...
#include <sou/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(sou::chain::table_id_object, sou::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(sou::chain::key_value_object, sou::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(sou::chain::index64_object, sou::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(sou::chain::index128_object, sou::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(sou::chain::index256_object, sou::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(sou::chain::index_double_object, sou::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(sou::chain::index_long_double_object, sou::chain::index_long_double_index)

FC_REFLECT(sou::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(sou::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(sou::chain::index64_object)
REFLECT_SECONDARY(sou::chain::index128_object)
REFLECT_SECONDARY(sou::chain::index256_object)
REFLECT_SECONDARY(sou::chain::index_double_object)
REFLECT_SECONDARY(sou::chain::index_long_double_object)
