...
#include <sou/chain/protocol_feature_activation.hpp>
...
FC_REFLECT(sou::chain::block_header,
           (timestamp)(producer)(confirmed)(previous)
           (transaction_mroot)(action_mroot)
           (schedule_version)(new_producers)(header_extensions))

FC_REFLECT_DERIVED(sou::chain::signed_block_header, (sou::chain::block_header), (producer_signature))
