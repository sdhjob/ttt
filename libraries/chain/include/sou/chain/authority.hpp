...
FC_REFLECT(sou::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(sou::chain::key_weight, (key)(weight) )
FC_REFLECT(sou::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(sou::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(sou::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(sou::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(sou::chain::shared_public_key, (pubkey))