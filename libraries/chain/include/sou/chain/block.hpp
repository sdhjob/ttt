...
FC_REFLECT_ENUM( sou::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(sou::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(sou::chain::transaction_receipt, (sou::chain::transaction_receipt_header), (trx) )
FC_REFLECT(sou::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(sou::chain::signed_block, (sou::chain::signed_block_header), (transactions)(block_extensions) )
