...
CHAINBASE_SET_INDEX_TYPE(sou::chain::permission_link_object, sou::chain::permission_link_index)

FC_REFLECT(sou::chain::permission_link_object, (account)(code)(message_type)(required_permission))
