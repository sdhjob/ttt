...
constexpr auto intrinsic_table = boost::hana::make_tuple(
   "souvmoc_internal.unreachable"_s,
   "souvmoc_internal.grow_memory"_s,
   "souvmoc_internal.div0_or_overflow"_s,
   "souvmoc_internal.indirect_call_mismatch"_s,
   "souvmoc_internal.indirect_call_oob"_s,
   "souvmoc_internal.depth_assert"_s,
   "eosio_injection.call_depth_assert"_s,  //these two are never used by SOU VM OC but all intrinsics
