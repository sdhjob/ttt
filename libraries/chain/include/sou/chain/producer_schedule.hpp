...
FC_REFLECT( sou::chain::legacy::producer_key, (producer_name)(block_signing_key) )
FC_REFLECT( sou::chain::legacy::producer_schedule_type, (version)(producers) )
FC_REFLECT( sou::chain::block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( sou::chain::producer_authority, (producer_name)(authority) )
FC_REFLECT( sou::chain::producer_authority_schedule, (version)(producers) )
FC_REFLECT_DERIVED( sou::chain::producer_schedule_change_extension, (sou::chain::producer_authority_schedule), )

FC_REFLECT( sou::chain::shared_block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( sou::chain::shared_producer_authority, (producer_name)(authority) )
FC_REFLECT( sou::chain::shared_producer_authority_schedule, (version)(producers) )
