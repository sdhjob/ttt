...
namespace sou { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in SOU code:
    *
    ...
    *  others are due to requirements to ensure determinism in the SOU chain library.
    *
...
FC_REFLECT_EMPTY( sou::chain::void_t )
