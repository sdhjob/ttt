...
CHAINBASE_SET_INDEX_TYPE(sou::chain::code_object, sou::chain::code_index)

FC_REFLECT(sou::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
