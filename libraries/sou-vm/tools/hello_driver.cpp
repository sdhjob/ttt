...
#include <sou/vm/error_codes.hpp>
#include <sou/vm/host_function.hpp>
#include <sou/vm/watchdog.hpp>
...
/**
 * Simple implementation of an interpreter using sou-vm.
 */
int main(int argc, char** argv) {
   ...
   using backend_t = sou::vm::backend<example_host_methods>;
   using rhf_t     = sou::vm::registered_host_functions<example_host_methods>;
   ...
   } catch (...) { std::cerr << "sou-vm interpreter error\n"; }
   return 0;
}
