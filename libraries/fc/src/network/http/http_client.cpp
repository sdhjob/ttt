...
public:
   ...
   /*
      ...
      unix:///home/username/sou-wallet/ksoud.sock/v1/wallet/sign_digest
      for example. When the fc::url is given to http_client in post_sync(), this will
      have proto=unix and host=/home/username/sou-wallet/ksoud.sock/v1/wallet/sign_digest
      ...
      host=/home/username/sou-wallet/ksoud.sock and path=/v1/wallet/sign_digest
