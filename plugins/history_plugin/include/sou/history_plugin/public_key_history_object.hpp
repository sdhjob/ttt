...
CHAINBASE_SET_INDEX_TYPE( sou::public_key_history_object, sou::public_key_history_multi_index )

FC_REFLECT( sou::public_key_history_object, (public_key)(name)(permission) )
