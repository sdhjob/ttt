...
CHAINBASE_SET_INDEX_TYPE( sou::account_control_history_object, sou::account_control_history_multi_index )

FC_REFLECT( sou::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
