...
#include <sou/wallet_plugin/wallet_api.hpp>
...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key SOU6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
       *
...
FC_REFLECT( sou::wallet::wallet_data, (cipher_keys) )

FC_REFLECT( sou::wallet::plain_keys, (checksum)(keys) )
